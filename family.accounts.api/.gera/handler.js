...
function run(toolbox){
    ...
    toolbox.gera.generate({
        ...
        target: `src/Family.Accounts.Core/Handlers/I${name}Handler.cs`,
        props: { 
            name:name,
        }
    })
    ...
    toolbox.gera.generate({
        ...
        target: `src/Family.Accounts.Application/Handlers/${name}Handler.cs`,
        props: { 
            name:name,
        }
    })
    ...
    toolbox.patching.patch('src/Family.Accounts.Api/Configurations/DependenceConfiguration.cs', { 
        insert: `\n${addTransient}`, 

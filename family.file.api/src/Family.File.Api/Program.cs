using Family.File.Api.Authorization;
...
using Family.File.Infrastructure.Repositories.External;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Family.File.Api", Version = "v1" });

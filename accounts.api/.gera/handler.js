...
function run(toolbox){
    ...
    toolbox.gera.generate({
        ...
        target: `src/Accounts.Core/Handlers/I${name}Handler.cs`,
        props: { 
            name:name,
        }
    })
    ...
    toolbox.gera.generate({
        ...
        target: `src/Accounts.Application/Handlers/${name}Handler.cs`,
        props: { 
            name:name,
        }
    })
    ...
    toolbox.patching.patch('src/Accounts.Api/Configurations/DependenceConfiguration.cs', { 
        insert: `\n${addTransient}`, 
